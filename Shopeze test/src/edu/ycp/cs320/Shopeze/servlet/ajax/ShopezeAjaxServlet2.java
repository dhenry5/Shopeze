package edu.ycp.cs320.Shopeze.servlet.ajax;
...
public class ShopezeAjaxServlet2 extends HttpServlet {
	...
	private void doRequest(HttpServletRequest req, HttpServletResponse resp)
		...
		ShopezeModel model = new ShopezeModel();
		model.setMin(min);
		model.setMax(max);
		...
		if (action != null) {
			ShopezeController controller = new ShopezeController();
